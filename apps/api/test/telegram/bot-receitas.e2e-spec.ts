...
describe('Bot command: /receitas [mês]', () => {
	...
	describe('happy path', () => {
		it('should reply with fixed and variable incomes for the month', () => {});

		it('should reply with empty message when there are no incomes', () => {});
	});
