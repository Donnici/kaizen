...
describe('Bot command: /despesas [mês]', () => {
	...
	describe('happy path', () => {
		it('should reply with fixed and variable expenses for the month', () => {});

		it('should reply with empty message when there are no expenses', () => {});
	});
